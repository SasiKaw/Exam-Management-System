...
class CoursesLecturer(models.Model):
    id = models.CharField(db_column='Id', primary_key=True, max_length=45)
    lectures = models.ForeignKey('Lecturers', models.DO_NOTHING, db_column='Lectures_ID')
    courses = models.ForeignKey('Courses', models.DO_NOTHING, db_column='Courses_ID')
...
class Subjects(models.Model):
    ...
    total_credit = models.IntegerField(db_column='Total_credit', blank=True, null=True)
    theory_credit = models.IntegerField(db_column='Theory_credit', blank=True, null=True)
    practical_credit = models.IntegerField(db_column='Practical_credit', blank=True, null=True)
    level = models.IntegerField(db_column='Level')
    programs = models.ForeignKey('Programs', models.DO_NOTHING, db_column='Programs_ID')
    ca = models.IntegerField(db_column='CA', default=40)  # Add this line
    fe = models.IntegerField(db_column='FE', default=60)  # Add this line
