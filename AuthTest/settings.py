...
SECRET_KEY = 'django-insecure-b@p0_a)qwyi4f9fjaq83xxfbxe_!2+p#^(a&ye)vb#-_p#lg@s'
...
MIDDLEWARE = [
    ...
    'user_auth.middleware.DatabaseSeedingMiddleware',
]
...
LOGIN_REDIRECT_URL =  'user_auth:dashboard'
